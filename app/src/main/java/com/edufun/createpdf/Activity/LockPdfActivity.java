...
public class LockPdfActivity extends AppCompatActivity {
    ActivityLockPdfBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        binding = ActivityLockPdfBinding.inflate(getLayoutInflater());
        ...
        binding.btnProtect.setOnClickListener(v -> {
            ...
            if (!userPass.isEmpty() && !ownerPass.isEmpty() && userPass.equals(ownerPass)){
                ...
                etFileName.setText("Protected PDF");
                dialog1.show();
...
//            pdfDetails(uri);
//            binding.bottomLayout.setVisibility(View.VISIBLE);
//            binding.btnSelectPdf.setVisibility(View.VISIBLE);
//        }
//    }
    ...
    private void lockPdf(Uri uri,String userPassword, String ownerPassword) {
        ...
        if (lockUri!=null){
            try {
                OutputStream out = resolver.openOutputStream(lockUri);
                ...
                if (inputStream!=null && out!=null) {
                    ...
                    stamper.setEncryption(
                            ...
                            0x04,    // This allows printing (equivalent to PdfReader.ALLOW_PRINTING)
                    ...
                    Toast.makeText(this, "Pdf Locked Successful", Toast.LENGTH_SHORT).show();
                    values.put(MediaStore.MediaColumns.IS_PENDING,0);
                    resolver.update(lockUri, values, null, null);
                    openPdf(lockUri,LockPdfActivity.this);
                }
